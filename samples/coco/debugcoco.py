...
class DenseCocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
        ...
        if not class_ids:
            ...
            print ("num class ids= {}".format(len(class_ids)))
        ...
        print ("num images original= {}".format(len(image_ids)))
        # Add classes
        for i in class_ids:
        ...
        for i in image_ids:
            ...
            if not annotations or len(annotations)<1:
                print ("skipping image id={} because it has no annotations".format(i))
                continue
            self.add_image(
                "coco", image_id=i,
                path=im_path,
        ...
        print ("num images currently in loaded datset= {}".format(len(self.image_info)))
        if return_coco:
            return coco
    ...
    def load_mask_and_dense_points(self, image_id):
        ...
        for annotation in annotations:
            ...
            if class_id:
                ...
                if 'dp_x' in annotation:
                    ...
                    empty_list=[0]
                    dense_x.append(empty_list)
                    dense_y.append(empty_list)
                    dense_u.append(empty_list)
                    dense_v.append(empty_list)
                    dense_i.append(empty_list)
        ...
        if class_ids:
            ...
            # return mask, class_ids #changed

        else:
            print ("no annotations found for image id ={}".format(image_id))
