...
def build_fpn_dense_shared_branch(rois,feature_maps, image_meta,
    ...
    for i in np.arange(config.BODY_UV_RCNN_NUM_STACKED_CONVS):
        ...
        curr=_timedistributed_depthwise_conv_block(curr, hidden_dim, strides=(1, 1), prefix="dense_shared_{}".format(i), train_bn=train_bn)
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            outputs = [rpn_class_logits, rpn_class, rpn_bbox,
                       mrcnn_class_logits, mrcnn_class, mrcnn_bbox,
                       rpn_rois, output_rois,
                       rpn_class_loss, rpn_bbox_loss, class_loss, bbox_loss,u_loss,v_loss,i_loss]
    ...
    def compile(self, learning_rate, momentum):
        ...
        loss_names = [
            ...
            "mrcnn_class_loss", "mrcnn_bbox_loss","u_loss","v_loss","i_loss"]
        # loss_names = [
        #     "rpn_class_loss",  "rpn_bbox_loss",
